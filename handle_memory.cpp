...
int readMemoryInt(HANDLE handle_process, int address, unsigned int dataSize)
{
	int value = 0;
...
std::vector<char> readMemoryBytes(HANDLE handle_process, int address, unsigned int dataSize)
{
...
std::string readMemoryString(HANDLE handle_process, int address, unsigned int dataSize)
{
	std::string value = "";
	char temp;
